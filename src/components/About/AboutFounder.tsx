      ...
      <div className=" space-y-6">
        ...
        <div className=" relative">
          <img
            ...
            alt="img"
            className="w-full max-h-[200px] lg:max-h-[350px] 2xl:max-h-[550px] object-cover object-center"
          />
          <motion.img
            ...
            ref={ref}
            style={{ opacity }}
            className="w-full max-h-[200px] lg:max-h-[350px] 2xl:max-h-[550px] object-cover object-center absolute inset-0"
          />
        </div>
