  ...
  return (
    <div className=" pt-20 md:pt-24">
      <div className=" flex flex-col lg:flex-row">
        <div
          className=" relative h-[60vh] w-full lg:w-1/2 p-8 lg:hover:w-3/4 bg-cover bg-center transition-all duration-1000 ease-in-out flex items-center justify-center overflow-hidden"
